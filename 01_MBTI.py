...
def MBTI():
    ...
    print("\n진정한 피로그래머에 도전하기 전, 성격 검사를 실시해 본인의 성향을 파악하세요.")
    print("<MBTI (piro ver.)>를 시작합니다.")
    print(line)
    ...
    print(line)
    print("<< 검사결과 >>\n")
    print("당신의 성격유형은 {}, ".format(result), end="")
    ...
    print(line)
    print("피로그래머가 되기 위한 사전준비가 모두 끝났습니다. 진정한 피로그래머에 도전하세요!")
